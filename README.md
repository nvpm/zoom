# Introduction
  ...
  Also, the very window that holds the text is also put in evidence, mainly in
  the middle of the screen. This plug-in is able  to do all that and more. The
  feature  can  mostly  be  appreciated  by  computer programmers,  novelists,
  journalists, paper writers, and others. Because  when  the  idea  comes, you
  don't wanna be distracted with tablines, filenames or anything else for that
  matter.
